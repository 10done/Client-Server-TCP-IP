...
class CaseServer:
    def __init__(self, host='localhost', port=12345):
        ...
        print(f"[*] Case Conversion Server listening on {host}:{port}")
    ...
    def handle_client(self, client_socket, client_address):
        ...
        try:
            while True:
                ...
                print(f"[CONVERTED] to uppercase: {uppercase_message}")
                
                # Send uppercase message back to client
                client_socket.send(uppercase_message.encode('utf-8'))
